...
namespace QBankApi.Controller
{
    ...
    {
        public FoldersController(CachePolicy cachePolicy, string apiAddress, IAuthenticator authenticator) : base(
        ...
        /// <param name="includeObjectCounts">Whether to return the number of objects each folder contains..</param>
        /// </summary>
        public virtual FolderResponse RetrieveFolder(
        ...
        /// <param name="id">The Folder identifier.</param>
        /// </summary>
        public virtual List<FolderParent> RetrieveParents(
        ...
        /// </summary>
        public virtual FolderResponse CreateFolder(
        ...
        /// </summary>
        public virtual Dictionary<string, object> AddMediaToFolder(
        ...
        /// </summary>
        public virtual FolderResponse UpdateFolder(
        ...
        /// </summary>
        public virtual Dictionary<string, object> RemoveMediaFromFolder(
        ...
        /// <param name="id">The Folder identifier.</param>
        /// </summary>
        public virtual FolderResponse RemoveFolder(
            int id)
        {
