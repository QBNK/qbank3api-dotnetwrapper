...
namespace QBankApi.Controller
{
    public class DeploymentController : ControllerAbstract
    {
        ...
        /// Lists all Protocols.
        /// </summary>
        public virtual List<Protocol> ListProtocols(
        ...
        /// </summary>
        public virtual Protocol RetrieveProtocol(
        ...
        /// </summary>
        public virtual List<DeploymentSiteResponse> ListSites(
            CachePolicy cachePolicy = null)
        {
        ...
        /// </summary>
        public virtual DeploymentSiteResponse RetrieveSite(
            int id, CachePolicy cachePolicy = null)
        {
        ...
        /// </summary>
        public virtual DeploymentSiteResponse CreateSite(
        ...
        /// </summary>
        public virtual DeploymentSiteResponse UpdateSite(
        ...
        /// <param name="id">The DeploymentSite identifier.</param>
        /// </summary>
        public virtual DeploymentSiteResponse RemoveSite(
            int id)
        {
        ...
        /// </summary>
        public virtual Dictionary<string, object> RemoveMediaFromDeploymentSite(
